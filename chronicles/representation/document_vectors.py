...
# %%
sesh = RepresentationHandler(model=model, primitives=primitives)

# a = sesh.find_doc_cossim(496, n_topics=sesh.n_topics)
# a.shape

# a = sesh.find_doc_cossim([496, 497], n_topics=sesh.n_topics)
# a.shape

# a = sesh.find_doc_vector(496)
# a.shape

# a = sesh.find_doc_vectors([496, 497])
# a.shape

# a = sesh.find_documents([496, 497])
# len(a)
